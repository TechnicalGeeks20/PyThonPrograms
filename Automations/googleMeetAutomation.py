...
def AskToJoin():
	...
	driver.implicitly_wait(2000)
	driver.find_element_by_xpath(
		'//*[@id="yDmH0d"]/c-wiz/div/div/div[9]/div[3]/div/div/div[4]/div/div/div[2]/div/div[2]/div/div[1]/div[1]/span').click()
	# Ask to join and join now buttons have same xpaths


# assign email id and password
mail_address = input("Email Address:")
...
# go to google meet
driver.get('https://meet.google.com/avj-emdv-jdw')
driver.implicitly_wait(2000)
turnOffMicCam()
AskToJoin()
# joinNow()
